...
function onLocationFound(e) {
    ...
    if(Object.keys(users).length > 0 && users[user]._latlng.lat!==e.latlng.lat&&
    ...
    //cambiar la posicuion de un usaurio en tiempo real
        ...
        socket.on('draw',(data)=>{
            ...
            if(Object.keys(users).length === 0 ){
                ...
                for(dato in data){
                    if(data[dato].online===true){
                        ...
                        users[dato]=L.marker(data[dato].coords/*,{draggable:true}*/).bindPopup("Estas a " + data[dato].radius + " metros de esta ubicacion").openPopup().addTo(map);
            ...
            //lo registrara en el objeto "users"
                ...
                users[last]=L.marker(data[last].coords,{/*draggable:true*/}).bindPopup("Estas a " + data[last].radius + " metros de esta ubicacion").openPopup().addTo(map);
